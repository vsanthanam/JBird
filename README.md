...
[![Swift Version](https://img.shields.io/badge/swift-Swift%206.1%20%7C%206.2-critical)](https://swift.org)
...
```swift
dependencies: [
    .package(url: "https://github.com/vsanthanam/JBird.git", from: "1.2.0")
]
```
